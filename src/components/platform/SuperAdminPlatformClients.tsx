  ...
  return (
    <SuperAdminShell user={user}>
      ...
      <div className="mt-6 flex gap-2">
        <input
          className="rounded-xl border border-white/10 bg-surface/50 px-3 py-2 text-sm"
      ...
      {loading ? (
        ...
        <ul className="mt-6 space-y-2">
          {flags.map((f) => (
            <li
              key={f.id}
              className="flex items-center justify-between rounded-2xl border border-white/10 bg-surface/40 px-4 py-3"
            >
              <div>
...
export function AnnouncementsClient({ user }: { user: SafeUser }) {
  ...
  return (
    <SuperAdminShell user={user}>
      ...
      <section className="mt-6 space-y-2 rounded-2xl border border-white/10 bg-surface/50 p-4">
        <input
      ...
      {loading ? (
        ...
        <ul className="mt-6 space-y-2">
          {items.map((a) => (
            <li key={a.id} className="rounded-2xl border border-white/10 bg-surface/40 px-4 py-3">
  ...
  return (
    <SuperAdminShell user={user}>
      ...
      {loading ? (
        ...
        <section className="mt-8 space-y-4 rounded-2xl border border-white/10 bg-surface/50 p-6">
          {warning && (
  ...
  return (
    <SuperAdminShell user={user}>
      ...
      <section className="mt-6 flex gap-2">
        <input
          className="flex-1 rounded-xl border border-white/10 bg-surface/50 px-3 py-2 text-sm"
      ...
      {loading ? (
        ...
        <ul className="mt-6 space-y-2">
          {items.map((i) => (
            <li key={i.id} className="rounded-2xl border border-white/10 bg-surface/40 px-4 py-3">
              <div className="text-xs text-muted">
  ...
  return (
    <SuperAdminShell user={user}>
      ...
      {loading ? (
        ...
        <ul className="mt-6 space-y-2">
          {items.map((b) => (
            <li key={b.id} className="rounded-2xl border border-white/10 bg-surface/40 px-4 py-3">
