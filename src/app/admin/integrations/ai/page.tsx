  ...
  return (
    <AdminShell user={toSafeUser(session.user)}>
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        <Link href="/admin/settings/ai" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">AI settings</div>
          <p className="mt-1 text-sm text-muted">Providers, modules, and defaults</p>
        </Link>
        <Link href="/admin/ai" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">AI intelligence</div>
          <p className="mt-1 text-sm text-muted">Overview of AI capabilities</p>
        </Link>
        <Link href="/admin/ai/health" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
