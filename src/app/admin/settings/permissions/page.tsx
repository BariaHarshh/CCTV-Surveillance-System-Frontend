  ...
  return (
    <AdminShell user={user}>
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        <Link href="/admin/staff" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">Staff accounts</div>
          <p className="mt-1 text-sm text-muted">Manage staff permissions</p>
        </Link>
        <Link href="/admin/users/invitations" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">Invitations</div>
          <p className="mt-1 text-sm text-muted">Invite admins and staff</p>
        </Link>
        <Link href="/admin/departments" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
