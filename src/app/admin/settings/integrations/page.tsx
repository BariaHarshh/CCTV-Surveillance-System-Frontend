  ...
  return (
    <AdminShell user={user}>
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2">
        <Link href="/admin/settings/integrations/webhooks" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">Webhooks</div>
          <p className="mt-1 text-sm text-muted">Outbound event deliveries</p>
        </Link>
        <Link href="/admin/integrations/ai" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
          <div className="font-semibold">AI providers</div>
          <p className="mt-1 text-sm text-muted">Detection and intelligence settings</p>
        </Link>
        <Link href="/admin/settings/api" className="rounded-2xl border border-white/10 bg-surface/50 p-5 hover:border-accent/40">
